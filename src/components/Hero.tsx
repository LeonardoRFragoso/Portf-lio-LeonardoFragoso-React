...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-dark-900 via-dark-800 to-dark-900 pt-16 overflow-hidden">
      {/* Animated background */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
        <div className="text-center space-y-8 animate-fade-in">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
            Desenvolvedor Python apaixonado por tecnologia, buscando criar soluções inovadoras
